...
function MealAndDishes() {
    ...
    const { type, price } = meal

    useEffect(() => {
        const getData = async () => {
            setMeal(await db.Meals.findOne(id))
        }
        getData()
    }, [id])
    ...
    // want this to be automatic after db update of any sort...
    useEffect(() => {
        const getData = async () => {
            ...
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        <TableRow>
                            <TableCell>
                                <TextField disabled id="DishId" label="Dish Id" value={dishId} onChange={event => setId(event.target.value)} />
                            </TableCell>
                            <TableCell>
